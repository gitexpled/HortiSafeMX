...
/*     */     } 
/*     */     
/*  40 */     System.out.println("GET 2222222222:::::::::::::::::::::::::::::::::::::::: ");
...
/*     */     
/*     */     try {
/*  67 */       ArrayList<cargaManual> datas = cargaManual2DB.getAll(filter, "", start, length);
/*     */       
/*  69 */       Iterator<cargaManual> f = datas.iterator();
/*     */       
/*  71 */       data.setRecordsFiltered(cargaManual2DB.getAllcount(filter));
/*  72 */       data.setRecordsTotal(cargaManual2DB.getAllcount(filter));
/*     */       
/*  74 */       while (f.hasNext()) {
...
/*     */ 
/*     */   
/*     */   @RequestMapping(value = {"/cargaManual2/add"}, method = {RequestMethod.PUT}, produces = {"application/json"})
/*     */   @ResponseBody
...
/*     */     
/* 104 */     resp = cargaManual2DB.insert(row);
/*     */ 
/*     */ 
/*     */ 
/*     */     
...
/*     */     } 
/*     */     
/* 122 */     cargaManual row = cargaManual2DB.getId(codigo);
/*     */     
/* 124 */     return row;
/*     */   }
/*     */ 
/*     */   
/*     */   @RequestMapping(value = {"/cargaManual2/put"}, method = {RequestMethod.PUT}, produces = {"application/json"})
/*     */   @ResponseBody
...
/*     */ 
/*     */   
/*     */   @RequestMapping(value = {"/cargaManual2/getAllOutFilter"}, method = {RequestMethod.GET}, produces = {"application/json"})
/*     */   @ResponseBody
...
/*     */   }
/*     */   
/*     */   @RequestMapping(value = {"/cargaManual2/updateAnalisis"}, method = {RequestMethod.PUT}, produces = {"application/json"})
/*     */   @ResponseBody
...
/* 170 */       return false;
/*     */     }
/* 172 */     return cargaManual2DB.UpdateAnalisis(row);
/*     */   }
/*     */ }


/* Location:              C:\Users\jose.rodriguez\Desktop\Nueva carpeta (3)\WEB-INF\classes\!\lib\data\json\procesos\cargaManual2Json.class
