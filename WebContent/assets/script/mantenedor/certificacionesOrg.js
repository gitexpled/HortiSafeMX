	...
	var handleDemo1 = function() {
		...
		grid.init({
					...
					dataTable : { 
						...
						"ajax" : {
							"url" : "/HortiSafeMX/"+"json/certificacionOrg/view", // ajax
																				// source
						},
						"columnDefs" : [
								{
	...
	var obtener = function() {
		$("#modal-modifica-certificacion").on(
				...
				function(e) {
					...
					$.ajax({
						type : 'GET',
						url : "/HortiSafeMX/json/certificacionOrg/" + id,
						data : "",
	...
	var editar = function() {
		...
		form1.validate({
					...
					submitHandler : function(form) {
						...
						$.ajax({
									url : "/HortiSafeMX/"+"json/certificacionOrg/put",
									type : "PUT",
	...
	var insertCertificacion = function(){
		...
		form1.validate({
					...
					submitHandler : function(form) {
						...
						$.ajax({
									url : "/HortiSafeMX/"+"json/certificacionOrg/insertCertificacion",
									type : "PUT",
									data : JSON.stringify(row),
									beforeSend : function(xhr) {
										xhr.setRequestHeader("Accept",
