	...
	var handleDemo1 = function() {
		...
		grid.init({
					...
					dataTable : { 
						...
						"ajax" : {
							"url" : "/HortiSafeMX/"+"json/productor/view", // ajax
																				// source
						},
						"columnDefs" : [
								{
	...
	var obtener = function() {
		$("#modal-modifica-productor").on(
				...
				function(e) {
					...
					$.ajax({
						type : 'GET',
						url : "/HortiSafeMX/json/productor/" + id,
						data : "",
						success : function(data) {
	...
	var editar = function() {
		...
		form1.validate({
					...
					messages : {
						...
						updateCodSap : {
							required : "Este campo es obligatorio",
							rangelength : "Debe ser mayor a 4 y menor a 6",
							alfanumerico : "Ingrese sólo valores alfanumericos"
						}
					...
					submitHandler : function(form) {
						...
						$.ajax({
									url : "/HortiSafeMX/"+"json/productor/put",
									type : "PUT",
	...
	var insertProductor = function(){
		...
		form1.validate({
					...
					messages : {
						...
						codSap : {
							required: "Este campo es obligatorio",
							rangelength : "No debe ser menor a 4 y mayor a 6 caracteres",
							alfanumerico : "ingrese valores alfanumericos"
						}
					...
					submitHandler : function(form) {
						...
						$.ajax({
									url : "/HortiSafeMX/"+"json/productor/insertProductor",
									type : "PUT",
									data : JSON.stringify(row),
									beforeSend : function(xhr) {
										xhr.setRequestHeader("Accept",
