	...
	var getView = function() {
		...
		grid.init({
					...
					dataTable : { 
						...
						"ajax" : {"url" : "/HortiSafeMX/"+"json/alarmaComponente/view"},
						"columnDefs" : [
	...
	var getId = function() {
		$("#modal-update").on(
				...
				function(e) {
					...
					$.ajax({
						type : 'GET',
						url : "/HortiSafeMX/json/alarmaComponente/" + id,
						data : "",
	...
	var update = function() {
		...
		form1.validate({
					...
					submitHandler : function(form) {
						...
						loading.show();
						$.ajax({
									url : "/HortiSafeMX/"+"json/alarmaComponente/put",
									type : "PUT",
	...
	var insert = function(){
		...
		form1.validate({
					...
					submitHandler : function(form) {
						...
						$.ajax({
									url : "/HortiSafeMX/"+"json/alarmaComponente/add",
									type : "PUT",
									data : search,
									beforeSend : function(xhr) {
										xhr.setRequestHeader("Accept",
