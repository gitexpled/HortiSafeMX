	...
	var handleDemo1 = function() {
		...
		grid.init({
					...
					dataTable : { 
						...
						"ajax" : {
							"url" : "/restPesticidaPE/"+"json/estadoProductorPro/view", // ajax
																				// source
						},
						"columnDefs" : [
						           {
						           ...
						           ,
						            ...
						            {
									///restPesticidaPE/json/detalleRest/"+colName+"/"+full[0]+"/"+especie+"
									///restPesticidaPE/json/detalleRest/"+colName+"/"+full[0]+"/"+especie+"
									"targets" : '_all' ,
									"searchable": false,
									"render" : function(data, type, full,meta) {
										...
										if (data=='Y')
											html="<a data-toggle='modal'  data-id='/restPesticidaPE/json/detalleRest/"+colName+"/"+full[0]+"/"+especie+"' href='#modal-informe'>SI</a>";
										else
											html="<a data-toggle='modal'  data-id='/restPesticidaPE/json/detalleRest/"+colName+"/"+full[0]+"/"+especie+"'  href='#modal-informe'>NO</a>";
