	...
	var handleDemo1 = function() {
		...
		grid.init({
					...
					dataTable : { 
						...
						"ajax" : {
							"url" : "/HortiSafeMX/"+"json/estadoProductorOrg/view", // ajax
																				// source
						},
						"columnDefs" : [
						           {
						           ...
						           ,
									...
									"render" : function(data, type, full,meta) {
										...
										if (data=='N')
											html="<a data-toggle='modal'  data-id='/HortiSafeMX/json/detalleRestOrg/"+colName+"/"+full[3]+"/"+full[4]+"/"+full[5]+"/"+especie+"/"+full[6]+"' href='#modal-informe'>NO</a>";
										else
											html="<a data-toggle='modal'  data-id='/HortiSafeMX/json/detalleRestOrg/"+colName+"/"+full[3]+"/"+full[4]+"/"+full[5]+"/"+especie+"/"+full[6]+"'  href='#modal-informe'>SI</a>";
