		...
		<div class="portlet-title">
			...
			<div class="btn-group" style="float: right;">
				...
				<ul class="dropdown-menu pull-right">
					<li><a href="/restPesticidaPE/webApp/exportaExcelParcela/1"> Export to Excel Normal</a></li>
					<li><a href="/restPesticidaPE/webApp/exportaExcelParcelaSap/1"> Export to Excel SAP</a></li>
