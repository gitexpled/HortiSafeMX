		...
		<div class="portlet-title">
			...
			<div class="btn-group" style="float: right;">
				...
				<ul class="dropdown-menu pull-right">
					...
					<li><a onclick="exportaExcelParcelaSap2()"> Export to SAP NEW MERCADO</a></li>
					<li><a onclick="exportaExcelParcelaSap2CLI()"> Export to SAP NEW CLIENTE</a></li>
			...
			<div class="btn-group" style="float: right;">
				...
				<ul class="dropdown-menu pull-right">
					<li><a href="/HortiSafeMX/json/SyncSAP/1" target="_blank">MERCADO</a></li>
					<li><a href="/HortiSafeMX/json/SyncSAP/2" target="_blank">CLIENTE</a></li>
