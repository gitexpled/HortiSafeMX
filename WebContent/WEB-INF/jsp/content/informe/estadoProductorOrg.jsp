		...
		<div class="portlet-title">
			...
			<div class="btn-group" style="float: right;">
				...
				<ul class="dropdown-menu pull-right">
					<li><a href="/HortiSafeMX/webApp/exportaExcel/1"> Export to Excel </a></li>
					<li><a href="/HortiSafeMX/webApp/exportaSap/1"> Export to SAP OLD</a></li>
					<li><a href="/HortiSafeMX/webApp/exportaExcelParcelaSap2/1"> Export to SAP NEW MERCADO</a></li>
					<li><a href="/HortiSafeMX/webApp/exportaExcelParcelaSap2CLI/1"> Export to SAP NEW CLIENTE</a></li>
				...
				<table
					...
					<thead>
						...
						<tr role="row" class="filter">
							<td></td><td></td><td></td><td><input type="text"
		...
		<form id="form-InsertTipoProducto" class="form-horizontal" role="form">
			<div class="modal-content">
				<div class="modal-header">
					<button type="button" class="close" data-dismiss="modal"
						aria-hidden="true"></button>
					<h4 class="modal-title">Informe Estado Organico</h4>
				</div>
				<div class="modal-body">
