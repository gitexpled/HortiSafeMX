				...
				<div class="form-body">
					...
					<div class="form-group">
						...
						<div class="form-group">
							...
							<div class="col-md-8">
								<div class="input-icon right">
									<input name="codTurno" id="codTurnoUpdate" type="text" class="form-control" placeholder="cod Sector">
								</div>
							</div>
						</div>
                           ...
                           <div class="col-md-8">
                                <div class="input-icon input-large">
                                    <div class="input-group">
                                        	...
                                        	<input name="codTurno" id="codTurno" type="text" class="form-control" placeholder="cod Sector">
                                      </div>
                                </div>
                            </div>
                        </div>
