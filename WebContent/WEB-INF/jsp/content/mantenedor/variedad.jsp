...
<div id="modal-modifica-variedad" class="modal fade" tabindex="-1"
	data-backdrop="static" data-keyboard="false">
	<div class="modal-dialog">
		<form id="modifica-variedad-form">
					...
					<div class="modal-body">
                           ...
                           <div class="col-md-8">
                                <div class="input-inline input-large">
                                    <div class="input-group">
                                        ...
                                        <select name="idEspecie" class="idEspecieSelect form-control" id="idEspecieUpd">
                                         	</select>
                                      </div>
                                </div>
                            </div>
                        ...
                        <div class="form-group">
                           ...
                           <div class="col-md-8">
                                <div class="input-inline input-large">
                                    <div class="input-group">
                                        <input name="regMercado" id="codVariedadUpd" type="text" class="form-control" placeholder="Cod Variedad"> 
                                      </div>
                                </div>
                            </div>
                        </div>
                        <div class="form-group">
                           ...
                           <div class="col-md-8">
                                <div class="input-inline input-large">
                                    <div class="input-group">
                                        <input name="Variedad" id="VariedadUpd" type="text" class="form-control" placeholder="Variedad"> 
                                      </div>
                                </div>
                            </div>
                        </div>
...
<!-- 						</div> -->
<!-- 						<div class="form-group"> -->
<!-- 							<label class="col-md-4 control-label">Certificacion Organica<span -->
<!-- 								class="required">*</span></label> -->
<!-- 							<div class="col-md-8"> -->
<!-- 								<select id="update_certificacionOrganica" name="update_certificacionOrganica" -->
<!-- 									class="form-control"> -->
...
<!-- 								class="required">*</span></label> -->
<!-- 							<div class="col-md-8"> -->
<!-- 								<select id="update_retricionPorcentaje" name="update_retricionPorcentaje" -->
<!-- 									class="form-control"> -->
<!-- 									<option value="">Elegir</option> -->
<!-- 								</select> <br /> <br /> -->
<!-- 							</div> -->
...
<!-- 						<div class="form-group"> -->
<!-- 							<label class="col-md-4 control-label">Porcentaje Suma: </label> -->
<!-- 							<div class="col-md-8"> -->
<!-- 								<div class="input-icon right"> -->
<!-- 									<i data-container="body" data-original-title="Usuario" -->
<!-- 										class="fa fa-info-circle tooltips"></i> <input type="text" -->
<!-- 										id="update_suma" name="update_suma" -->
<!-- 										value="" class="form-control"> <br /> -->
<!-- 								</div> -->
<!-- 							</div> -->
<!-- 						</div> -->
...
<!--                                 <div class="input-inline input-large"> -->
<!--                                     <div class="input-group"> -->
<!--                                         <input name="regMercado" id="regCorreo" type="text" class="form-control" placeholder="Correo">  -->
<!--                                       </div> -->
<!--                                 </div> -->
<!--                             </div> -->
<!--                         </div> -->
<!--                         <div class="form-group"> -->
<!--                             <label class="col-md-4 control-label">Plataforma</label> -->
<!--                            <div class="col-md-8"> -->
<!--                                 <div class="input-inline input-large"> -->
<!--                                     <div class="input-group"> -->
<!--                                         <span class="input-group-addon" id="sizing-addon1">@</span> -->
<!--                                         <input name="regMercado2" id="regPlataforma" type="text" class="form-control" placeholder="Plataforma">  -->
<!--                                       </div> -->
<!--                                 </div> -->
<!--                             </div> -->
<!--                         </div> -->
...
<!--                         </div> -->
                           ...
                           <div class="col-md-8">
                                <div class="input-inline input-large">
                                    <div class="input-group">
                                        ...
                                        <select name="idMercadoPadre" class="idEspecieSelect form-control" id="idEspecie">
                                         		<option value="">Seleccionar</option>
                                         		<option value="Chile">Chile</option>
                                         		<option value="Trujillo">Trujillo</option>
                                         		<option value="Olmos">Mlmos</option>
                        ...
                        <div class="form-group">
                           ...
                           <div class="col-md-8">
                                <div class="input-inline input-large">
                                    <div class="input-group">
                                        <input name="regMercado" id="codVariedad" type="text" class="form-control" placeholder="Cod Variedad"> 
                                      </div>
                                </div>
                            </div>
                        </div>
                        <div class="form-group">
                           ...
                           <div class="col-md-8">
                                <div class="input-inline input-large">
                                    <div class="input-group">
                                        <input name="Variedad" id="Variedad" type="text" class="form-control" placeholder="Variedad"> 
                                      </div>
                                </div>
                            </div>
                        </div>
